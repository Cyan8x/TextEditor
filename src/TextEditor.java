...
public class TextEditor extends JFrame implements ActionListener{
	...
	TextEditor(){
		...
		//Label(titulo del input) del tamaño de letras
		fontSizeLabel = new JLabel("Font Size: ");
		
		//Input de Tamaño de letras
		...
		fontSizeSpinner.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				if ((int)fontSizeSpinner.getValue() <= 0) {
					fontSizeSpinner.setValue(0);
				}
			}
		});
		
		//Input color de letra
		fontColorButton = new JButton("Color");
		fontColorButton.addActionListener(this);
		
		//Combo Box de font Family
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == fontColorButton) {
			...
			Color color = colorChooser.showDialog(null, "Elija un color", Color.BLACK);
			textArea.setForeground(color);
		}
		
		//Font Family
		if (e.getSource() == fontFamilyComboBox) {
			textArea.setFont(new Font((String)fontFamilyComboBox.getSelectedItem(), Font.PLAIN, textArea.getFont().getSize()));
		}
